export const FrontStack = [
  ...
  {name: 'Thymeleaf', icon: 'https://www.thymeleaf.org/doc/images/thymeleaf.png'},
...
export const EmbeddedStack = [
  ...
  {name: 'ESP32', icon: 'https://avatars.githubusercontent.com/u/9460735?s=200&v=4'}
];
...
export const testStack = [
  ...
  {name: 'xUnit', icon: 'https://avatars.githubusercontent.com/u/2092016?s=200&v=4'}
];

export const devOpsStack = [
  {name: 'Docker', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/docker/docker-original.svg'},
  {name: 'Azure', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/azure/azure-plain.svg'}
];